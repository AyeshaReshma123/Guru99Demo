...
And(`Validate the Profile Page section`, ()=> {
    let profileValues = [`Title:`, `Firstname:`, `Surname:`,`Phone:`,`Dataofbirth:`,`License type:`,`License period:`,`Occupation:`,`Driver History:`],i=0;
    profileValues.forEach((element, i) =>{
        cy.xpath(`//div[@class='content']//div[@id='tabs-4']`).should('contain', element);
    })
});
